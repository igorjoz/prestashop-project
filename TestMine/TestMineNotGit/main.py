...
def testEFGH(driverE, source):
    ...
    try:
        ...
        try:
            WebDriverWait(driver=driverE, timeout=5).until(
                EC.presence_of_element_located((By.ID, "checkout-personal-information-step"))
            )
            result[0] = "passed"
        ...
        try:
            ...
            second_stage_address = necessary_second_stage_rows[4].find_element(By.XPATH,
                                                                               ".//input[@class='form-control']")
            second_stage_postcode = necessary_second_stage_rows[6].find_element(By.XPATH,
                                                                                ".//input[@class='form-control']")
            second_stage_city = necessary_second_stage_rows[7].find_element(By.XPATH, ".//input[@class='form-control']")
            second_stage_phone = necessary_second_stage_rows[9].find_element(By.XPATH,
                                                                             ".//input[@class='form-control']")
